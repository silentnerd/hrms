...
=======
  ...
  return (
    ...
    <Col span={24}>           
        ...
        <Row gutter={24}>
           ...
           <TextArea placeholder="Reason" autosize={{ minRows: 2, maxRows: 8 }}
           />
          ...
          <Button type="primary" style={{float: 'right'}}>Request</Button>
          <Button type="danger" style={{float: 'right', marginRight: '10px'}}>Clear</Button>
  ...
  <Col span={8}>
    ...
    <Row>
           ...
           <Breadcrumb style={{ margin: '16px 0' }}>
            <Breadcrumb.Item> Carry Forward Leave Request</Breadcrumb.Item>
            </Breadcrumb>
